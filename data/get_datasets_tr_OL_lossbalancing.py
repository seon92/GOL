...
from data.datasets import OL_lossbalancing_train, basic
...
def get_datasets(cfg):
    ...
    loader_dict = dict()
    loader_dict['train'] = DataLoader(OL_lossbalancing_train.OLLossBalancing_Train(tr_imgs, tr_ages, cfg.transform_tr, cfg.tau, logscale=cfg.logscale, is_filelist=cfg.is_filelist),
