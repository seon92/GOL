...
from data.datasets import OL_mining_train, basic
...
def get_datasets(cfg):
    ...
    loader_dict = dict()
    loader_dict['train'] = DataLoader(OL_mining_train.OLMining_Train(tr_imgs, tr_ages, cfg.transform_tr, cfg.tau, max_epoch=cfg.epochs),
                                      batch_size=cfg.batch_size, shuffle=True, drop_last=True, num_workers=cfg.num_workers)
    loader_dict['train_for_val'] = DataLoader(basic.Basic(tr_imgs, tr_ages, cfg.transform_te, cfg.tau),
                                    batch_size=cfg.batch_size, shuffle=False, drop_last=False,
                                    num_workers=cfg.num_workers)

    loader_dict['val'] = DataLoader(basic.Basic(te_imgs, te_ages, cfg.transform_te, cfg.tau),
